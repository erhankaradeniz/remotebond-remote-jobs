        ...
        <div className="max-w-screen-xl mx-auto flex py-4 px-4 sm:px-6">
          <div className="w-4/3">
            <Link href={`/`}>
              <a title="Return to RemoteBond homepage" className="flex">
                ...
                <span className="flex items-center text-white font-semibold tracking-tighter text-xl">
                  RemoteBond
                </span>
              </a>
            </Link>
          ...
          <div className="w-1/4 text-right">
            <span className="inline-flex rounded-md shadow-sm">
              <button
                type="button"
                className="inline-flex items-center px-6 py-3 border border-transparent text-base leading-4 font-medium rounded-md text-white bg-blue-600 hover:bg-blue-500 focus:outline-none focus:border-blue-700 focus:shadow-outline-blue active:bg-blue-700 transition ease-in-out duration-150"
              >
                Post a job
              </button>
            </span>
