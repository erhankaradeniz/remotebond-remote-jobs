...
const createRssFeed = (jobs) => {
  return `<?xml version="1.0" encoding="UTF-8"?>
    <rss version="2.0" xmlns:dc="http://purl.org/dc/elements/1.1/">
      <channel>
          <title><![CDATA[Remotebond: Remote Sales and Marketing jobs]]></title>
          <link>https://remotebond.com/remote-sales-marketing-jobs.rss</link>
          <description>
            <![CDATA[Remotebond: Remote Sales and Marketing jobs]]>
          </description>
            ...
            .map((job) => {
              return `
                  <item>
                    ...
                    <link>https://remotebond.com/remote-jobs/${
                      job.data.slug
                    }</link>
                    <pubDate>${job.data.pub_date}</pubDate>
                    <guid>https://remotebond.com/remote-jobs/${
                      job.data.slug
                    }</guid>
                    <location>${
